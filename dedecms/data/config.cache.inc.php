...
$cfg_basehost = 'http://wei.cc';
$cfg_cmspath = '';
$cfg_cookie_encode = 'RGLNdkOWfBFePDTTwewrTwLtxUiC';
$cfg_indexurl = '/';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '微商城,微店铺,微商店,微信分销,微信公众平台';
$cfg_description = '微易点 是国内独特的微信公众平台的二次建设及服务。微易点免费帮您开通微商城(利用微信公众号进行商品或者服务买卖)，精美微官网建设，专为汽车用品，家电家具行业开发经销商管理系统，红包服务。';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
